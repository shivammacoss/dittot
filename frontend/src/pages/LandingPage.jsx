  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-[100] transition-colors duration-300 h-[64px] flex items-center ${
        isScrolled ? 'bg-[#1a1a3e] border-b border-[#2d2d5a]' : 'bg-transparent'
      }`}
    >
      <div className="max-w-[1440px] mx-auto px-[24px] lg:px-[60px] flex items-center justify-between w-full">
        <div className="flex items-center gap-[34px]">
          <a href="/" className="flex items-center">
            <img
              src="/src/assets/DittoTlogopng.png"
              alt="DittoT Logo"
              className="h-[50px] w-auto object-contain"
            />
          </a>
          <div className="hidden md:flex items-center gap-[24px]">
            <button className="flex items-center gap-[4px] text-white hover:text-[#4CAF50] transition-colors text-[16px] font-medium py-2">
              What We Offer <ChevronDown size={16} />
            </button>
            <a href="#" className="text-white hover:text-[#4CAF50] transition-colors text-[16px] font-medium py-2">
              Support
            </a>
          </div>
        </div>
        <div className="flex items-center gap-[12px] md:gap-[24px]">
          ...
          <button
            ...
            className="text-white hover:text-[#4CAF50] transition-colors text-[16px] font-medium hidden sm:block"
          >
            Log in
          </button>
          <button
            onClick={() => navigate('/user/signup')}
            className="bg-[#4CAF50] text-white px-[20px] py-[10px] rounded-[24px] text-[16px] font-bold hover:brightness-110 transition-all whitespace-nowrap"
          >
            Sign up
          </button>
        </div>
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-[#110E08]">
      <div className="absolute inset-0 z-0">
        ...
        >
          <source 
            src="/src/assets/DittoTvideo.mp4" 
            type="video/mp4" 
          />
        </video>
        <div 
          className="absolute inset-0 pointer-events-none" 
          style={{ background: 'radial-gradient(circle at center, rgba(26, 26, 62, 0) 0%, rgba(26, 26, 62, 0.4) 100%)' }} 
        />
      </div>
...
const InvestStockTokens = () => {
  return (
    <section className="bg-[#4CAF50] text-white overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-6 md:px-[60px] py-20 md:py-[140px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-[120px] items-start">
          ...
          <div className="flex flex-col max-w-[480px]">
            ...
            <div className="text-[18px] leading-[1.6] mb-10 text-white/90">
              Explore 2,000+ Stock Tokens linked to NVIDIA, Microsoft, Apple, Vanguard S&P 500 ETF, and more.
            </div>
            <div className="mb-20">
              <a href="#" className="inline-block bg-[#1a1a3e] text-white px-8 py-[14px] rounded-[24px] font-medium text-[16px] hover:opacity-90 transition-opacity">
                Learn more
              </a>
            </div>
            <p className="text-[12px] leading-[1.6] text-white/70">
              Stock Tokens are derivative contracts between you and DittoT. They carry a high level of risk and are not appropriate for all investors.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-[60px] relative z-10">
        <div className="max-w-[480px]">
          <div className="mb-8 flex items-center gap-2">
            <span className="text-white text-[24px] font-medium">DittoT Crypto</span>
          </div>
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-[64px] lg:gap-[80px]">
          ...
          <div className="w-full lg:w-[480px] flex flex-col pt-0 lg:pt-[40px]">
            ...
            <div className="mb-[48px]">
              <a href="#" className="inline-block bg-[#4CAF50] text-white text-[16px] font-semibold py-[12px] px-[24px] rounded-[24px] hover:opacity-90 transition-opacity">
                Learn more
              </a>
            </div>
    ...
    <section className="relative w-full min-h-[800px] flex items-center justify-center overflow-hidden bg-[#000000]">
      ...
      <div className="relative z-20 max-w-[1440px] mx-auto px-[60px] text-center">
        <div className="flex flex-col items-center justify-center">
          ...
          <button
            onClick={() => navigate('/user/signup')}
            className="inline-flex items-center justify-center bg-[#4CAF50] text-white text-[16px] font-medium px-[28px] py-[14px] rounded-[32px] hover:opacity-90 transition-opacity duration-200"
          >
            Get started
          </button>
...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#4CAF50] text-white py-14 px-6 md:px-[60px]">
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6 text-[12px] leading-[1.6]">
            ...
            <p> 2025 DittoT. All rights reserved.</p>
          </div>
        </div>
...
const LandingPage = () => {
  return (
    <div className="flex flex-col min-h-screen bg-[#1a1a3e]">
      <Navigation />
      <main>
        <HeroSection />
        <InvestStockTokens />
